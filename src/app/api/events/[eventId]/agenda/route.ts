...
import { listAgendaItems, createAgendaItem } from "@/lib/db/queries/wizard-extras";
import { createAgendaItemSchema } from "@/lib/validators/wizard-extras";
...
export async function POST(req: Request, { params }: RouteParams) {
  ...
  const result = await createAgendaItem(eventId, parsed.data);
